...
Here you can run toggle script to turn off vrr (vrr-safe-toggle), timeshift, or restore files from backup using "restore original files from backup" commands above
