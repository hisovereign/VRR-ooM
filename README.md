...
demo: https://youtu.be/quNHG3MPImQ

⚠️ FLASH WARNING ⚠️ **Muffin/Cinnamon have been added to mesa blacklist because some monitors may start flickering or show odd behavior with VRR on. If you are experiencing this please run toggle again to turn off vrr, revert steps, or timeshift.** 
...
**If VRR is left on during a reboot then on you may, on occasion, log into a blackscreen and/or only see your mouse. You can go into TTY and then back to reset it or turn off VRR with toggle**
...
Here you can run toggle script to turn off vrr (vrr-safe-toggle), timeshift, or restore files from backup using "restore original files from backup" commands above then restart cinnamon or reboot for changes to take affect.
